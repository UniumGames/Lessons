...
Чтобы писать программы, необходимо установить редактор кода. Мы будем использовать [MonoDevelop](http://www.monodevelop.com/). Он полностью бесплатен. 
...
void Start() {
	...
	int c = a + b; // складываем a и b, разультат сохраняем в c
