...
Сообщения отображаются в виде списка Чтобы очистить список нажми кнопку «Clear».

### Установка среды разработки

Чтобы писать программы необходимо установить редактор кода. Мы будем использовать Visual Studio. [Бесплатная версия](https://www.visualstudio.com/ru/vs/visual-studio-express/) требует регистрации через месяц после установки
